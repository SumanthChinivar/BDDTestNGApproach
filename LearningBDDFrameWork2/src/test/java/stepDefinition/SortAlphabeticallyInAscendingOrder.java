...
public class SortAlphabeticallyInAscendingOrder extends BaseClass{
	WebDriver driver=DriverFactory.getDriver();
	List<WebElement> list;
	List<String> expectedTitle=new ArrayList<String>();
	@Given("User selects {string} drop down to sort the products in ascending order")
	public void user_clicks_on_drop_down(String visibleText) {
	...
	public void products_should_be_sorted_in_ascending_order_of_alphabets() {
